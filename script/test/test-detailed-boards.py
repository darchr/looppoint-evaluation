...
parser = argparse.ArgumentParser(description="test to run the whole workload with detailed board")
parser.add_argument("--workload", help="The workload to run", type=str, default="ep")
