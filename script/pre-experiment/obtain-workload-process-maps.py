...
if args.arch == "arm":
    ...
    workload = get_arm_npb_workload(bench, class_size, obtain_process_maps=True, start_from_after_boot_checkpoint=True)
    ...
    workload = get_riscv_npb_workload(bench, class_size, obtain_process_maps=True, start_from_after_boot_checkpoint=True)
    board = get_functional_board()
elif args.arch == "x86":
    ...
    workload = get_x86_npb_workload(bench, class_size, obtain_process_maps=True, start_from_after_boot_checkpoint=True)
    board = get_functional_board()
